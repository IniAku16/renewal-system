                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="index.php?page=admin_dashboard&action=delete_user&id=<?= $user['id_user'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus user?')"><i class="bi bi-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
